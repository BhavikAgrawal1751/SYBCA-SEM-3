...
{
    char ch;
    fp.open("book\\C:\\LIB.txt", ios::out | ios::app); // write and append data
    do
    {
        system("cls");
        bk.createbook();
...
{
    char ch;
    fp.open("student\\C:\\LIB.txt", ios::out | ios::app); // write and append data
    do
    {
        system("cls");
        st.createstudent();
...
void displayspb(char n[])
{
    ...
    fp.open("book\\C:\\LIB.txt", ios::in); // read data
...
void displaysps(char n[])
{
    ...
    fp.open("student\\C:\\LIB.txt", ios::in); // read data
...
void modifybook()
{
    ...
    cout << "\n\nEnter the book no. ";
    cin >> n;
    fp.open("book\\C:\\LIB.txt", ios::in | ios::out);
...
void modifystudent()
{
    ...
    cout << "\n\nEnter the Admission no. ";
    cin >> n;
    fp.open("student\\C:\\LIB.txt", ios::in | ios::out);
...
void deletestudent()
{
    ...
    fp.open("student\\C:\\LIB.txt", ios::in | ios::out);
    fstream fp2;
    fp2.open("temp\\C:\\LIB.txt", ios::out);
    fp.seekg(0, ios::beg);
    while (fp.read((char *)&st, sizeof(student)))
    {
        if (strcmp(st.retadmno(), n) != 0)
    ...
    fp2.close();
    fp.close();
    remove("student\\C:\\LIB.txt");
    rename("temp\\C:\\LIB.txt", "student\\C:\\LIB.txt"); // data after deletion moved to temp
    if (flag == 1)
    {
        cout << "\n\n\tRecord Deleted..";
    }
...
void deletebook()
{
    ...
    fp2.open("Temp\\C:\\LIB.txt", ios::out); // temp having data else than that to be deleted
    fp.seekg(0, ios::beg);
    while (fp.read((char *)&bk, sizeof(book)))
    {
        if (strcmp(bk.retbno(), n) != 0)
    ...
    fp2.close();
    fp.close();
    remove("book\\C:\\LIB.txt");
    rename("Temp\\C:\\LIB.txt", "book\\C:\\LIB.txt"); // data after deletion moved to temp
    if (flag == 1)
    {
        cout << "\n\n\tRecord Deleted... ";
    }
...
{
    system("cls");
    fp.open("student\\C:\\LIB.txt", ios::in); // read mode
    if (!fp)
    {
...
{
    system("cls");
    fp.open("book\\C:\\LIB.txt", ios::in); // read mode
    if (!fp)
    {
        cout << "File Could Not Be Open";
        getch();
...
void bookissue()
{
    ...
    cin >> sn;
    fp.open("student\\C:\\LIB.txt", ios::in | ios::out);
    fp1.open("book\\C:\\LIB.txt", ios::in | ios::out);
    while (fp.read((char *)&st, sizeof(student)) && found == 0)
    {
